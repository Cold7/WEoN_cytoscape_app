...
public class CreateNetworkTask extends AbstractTask {
	...
	public void run(TaskMonitor monitor) {
		...
		myNet.getRow(myNet).set(CyNetwork.NAME, namingUtil.getSuggestedNetworkTitle("WEoN"));	
		...
		frame = new JFrame("WEoN - Weighted Epigenomic Networks");
...
////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JLabel dialoglblStep = new JLabel("WeON will run using each of the marks for which you loaded a file.");
		...
		//run weon button
		JButton btnRunWeon = new JButton("Run WEoN");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(f2.exists()) { 
						...
						writer.write("comb_PTMs_filter = Y\n");
					} else {
					...
					writer.write("GENEs_file = "+System.getProperty("user.home")+"/WEoN/example_data/dmel-all-filtered-r6.12-GENES.gff\n");
...
//						fr = new FileReader(refNetFile);
//						br = new BufferedReader(fr);
//						String sCurrentLine;
//						while ((sCurrentLine = br.readLine()) != null) {
//							sCurrentLine.replace("Distance:", "D_region =");
...
//						File fa = new File(h3k27me3);
//						File fb = new File(h3k27ac);
//						File fc = new File(h3k36me2);
//						File fd = new File(h3k4me2);
//						File fe = new File(h3k4me3);
//						File ff = new File(h3k9ac);
//						File fg = new File(h3k9me2);
//						File fh = new File(h3k9me3);
//						File fi = new File(h4k20me3);
//						if(fd.exists() && ff.exists() &&) { 
//							
//						}
//						if (fe.exists() && fd.exists() && ff.exists()) {
//						}
//						if(fe.exists() && ff.exists() &&) {
//							
//						}
				...
				//doing a system call perl main.pl -r config -n red ref(1500) -o out
       			...
       			try {
					...
					if(f111.exists()) { 
       				...
       				String netToUse = "out_TFBS_network_"+net.replaceAll("Distance: ","").replace("nt","")+".tsv";// "out_TFBS_network_1500.tsv";
       				JOptionPane.showMessageDialog(panel, "Running WEoN. This could take several time, please be patient",  "Info", JOptionPane.INFORMATION_MESSAGE);
       				System.out.println("perl "+System.getProperty("user.home")+"/WEoN/main.pl -r "+System.getProperty("java.io.tmpdir")+"/config_"+ID+" -n "+netToUse+" -o \""+outputFolder+"\"");
					Process p = Runtime.getRuntime().exec("perl "+System.getProperty("user.home")+"/WEoN/main.pl -r "+System.getProperty("java.io.tmpdir")+"/config_"+ID+" -n "+netToUse+" -o "+outputFolder);
					p.waitFor();
					System.out.println("done.");
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(panel, "Can not run WEoN",  "Error", JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				}
       			catch (InterruptedException e1) {
					// TODO Auto-generated catch block
       				JOptionPane.showMessageDialog(panel, "bad execution of WEoN",  "Error", JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				}
				/*
				//loading results
				...
				*/
				String line = null;
				String fileName = outputFolder+"/specific_GRN.tsv";
				try {
		        	...
		        	JOptionPane.showMessageDialog(panel, "Error, WEoN can not generate your condition specific network",  "Error", JOptionPane.ERROR_MESSAGE);
		            System.out.println(
		                "Unable to open file '" + 
		                fileName + "'");                
		        }
		        catch(IOException ex) {
		        	JOptionPane.showMessageDialog(panel, "Error, WEoN can not read your condition specific network",  "Error", JOptionPane.ERROR_MESSAGE);
		            System.out.println(
		                "Error reading file '" 
		                + fileName + "'");                  
